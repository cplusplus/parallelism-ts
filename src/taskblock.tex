...
\pnum Every \tcode{task_block} has an associated exception list. When the task block starts, its associated exception list is empty.
...
\pnum The order of the exceptions in the \tcode{exception_list} object is unspecified.
